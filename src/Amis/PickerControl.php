 ...
 * @method self pickerSchema($value) 弹窗选择框详情。
 * @method self embed($value) 内嵌模式，也就是说不弹框了。
 ...
 * @method self modalMode($value) 弹窗模式，dialog 或者 drawer 可选值: dialog | drawer | 
 ...
 * @method self labelTpl($value) 可用来生成选中的值的描述文字
 ...
 * @method self valueField($value) 选一个可以用来作为值的字段。
 ...
 * @method self labelField($value) 建议用 labelTpl 选中一个字段名用来作为值的描述文字
