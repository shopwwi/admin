 ...
 * @method self actionType($value) 指定为打开弹窗，抽出式弹窗
 ...
 * @method self drawer($value) 抽出式弹框详情 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/drawer
