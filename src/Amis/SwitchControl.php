 ...
 * @method self falseValue($value) 未勾选值
 * @method self validateApi($value) 远端校验表单项接口
 * @method self option($value) 选项说明
 * @method self offText($value) 关闭时显示的内容
 * @method self staticClassName($value) 静态展示表单项类名
 * @method self size($value) 开关尺寸 可选值: sm | md | 
 ...
 * @method self trueValue($value) 勾选值
 * @method self onText($value) 开启时显示的内容
 ...
 * @method self type($value) 指定为多行文本输入框
 */
