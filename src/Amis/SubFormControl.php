 ...
 * @method self type($value) 指定为 SubForm 子表单
 ...
 * @method self itemClassName($value) 值元素的类名
 * @method self form($value) 子表单详情
 ...
 * @method self minLength($value) 最少个数
 ...
 * @method self itemsClassName($value) 值列表元素的类名
 ...
 * @method self draggableTip($value) 拖拽提示信息
 ...
 * @method self maxLength($value) 最多个数
