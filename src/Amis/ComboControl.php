 ...
 * @method self scaffold($value) 单组表单项初始值。默认为 `{}`
 ...
 * @method self conditions($value) 符合某类条件后才渲染的schema
 ...
 * @method self type($value) 指定为组合输入框类型
 ...
 * @method self items($value) 数组输入框的子项
