...
{
    protected $model = \Shopwwi\Admin\App\User\Models\UserLabel::class;
    protected $orderBy = ['id' => 'desc'];
    protected $trans = 'userLabel'; // 语言文件名称
    protected $queryPath = 'user/label'; // 完整路由地址
    protected $activeKey = 'userMangeLabel';

    /**
     * 路由注册
     * @var string
     */
     public $routePath = 'label'; // 当前路由模块不填写则直接控制器名
    ...
    protected function fields(){
        return [
            ...
            shopwwiAmisFields(trans('field.name',[],'userLabel'),'name')->rules('required')->showFilter(),
            ...
            shopwwiAmisFields(trans('field.remark',[],'userLabel'),'remark')->column('textarea',['md'=>12]),
