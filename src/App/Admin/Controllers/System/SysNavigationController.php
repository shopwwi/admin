...
class SysNavigationController extends AdminController
{
    ...
    protected function fields(){
        ...
        return [
            ...
            shopwwiAmisFields(trans('field.image',[],'sysNavigation'),'imageUrl')->column('input-image',['md'=>12,'autoFill'=>['image'=>'${file_name}'],'initAutoFill'=>false,'crop'=>['aspectRatio'=>3],'receiver'=>shopwwiAdminUrl('common/upload')])->showColumn('control',['body'=>['type'=>'image','name'=>'imageUrl','width'=>90,'height'=>90]])->showOnIndex(0)->showOnCreation(3)->showOnUpdate(3),
