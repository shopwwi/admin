...
class SysArticleController extends AdminController
{
    ...
    protected function fields(){
        ...
        return [
            ...
            shopwwiAmisFields(trans('field.image',[],'sysArticle'),'imageUrl')->column('input-image',['autoFill'=>['image'=>'${file_name}'],'initAutoFill'=>false,'crop'=>['aspectRatio'=>3],'receiver'=>shopwwiAdminUrl('system/user/upload')])->showColumn('control',['body'=>['type'=>'image','name'=>'imageUrl','width'=>90,'height'=>90]])->showOnIndex(0)->showOnCreation(3)->showOnUpdate(3),
