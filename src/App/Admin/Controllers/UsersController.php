...
class UsersController extends AdminController
{
    ...
    protected function fields(){
        ...
        return [
            ...
            shopwwiAmisFields(trans('field.avatar',[],'users'),'avatarUrl')->column('input-image',['autoFill'=>['avatar'=>'${file_name}'],'initAutoFill'=>false,'crop'=>['aspectRatio'=>3],'receiver'=>shopwwiAdminUrl('user/users/upload')])->showColumn('control',['body'=>['type'=>'image','name'=>'avatarUrl','width'=>90,'height'=>90]])->showOnIndex(0)->showOnCreation(3)->showOnUpdate(3),
