...
use support\Log;
use Shopwwi\Admin\Libraries\Log\CustomLogInterface;
use Shopwwi\Admin\Libraries\Log\Middleware as LogMiddleware;
/**
...
class Http
{
    ...
    public static function instance(): Factory
    {
        if (static::$config === null) {
            static::$config = config('plugin.shopwwi.admin.app.http', []);
        }
